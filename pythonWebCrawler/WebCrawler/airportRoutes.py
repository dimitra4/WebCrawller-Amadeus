...
listOfDestinations = [{'name': 'LISBON', 'iataCode': 'LIS'} ]
    ...
    # {'name': 'AMSTERDAM', 'iataCode': 'AMS'}, ,
     # {'name': 'MYKONOS', 'iataCode': 'JMK'}, {'name': 'PARIS', 'iataCode': 'PAR'}, {'name': 'MADRID', 'iataCode': 'MAD'}  ]
        ...
        for j in listOfDestinations:
            ...
            for i in list:
                ...
                for r in res['itineraries'][0]['segments'][-1:]:
                    res1 = dict((k, r[k]) for k in ['arrival', 'carrierCode', 'number', 'departure']
                                if k in r)
