...
listOfDestinations = ['JMK', 'PAR', 'ROM', 'MAD', 'BCN', 'JTR', 'HER', 'IST', 'AMS', 'LIS']
amadeus = Client(
...
try:
    ...
    for j in listOfDestinations:
        for i in list:
            res = dict((k, i[k]) for k in ['price', 'itineraries', 'lastTicketingDate', 'lastTicketingDateTime']
                       if k in i)
            Dict['id'] = i['id']
            Dict['price'] = res['price']['total']
            Dict['departure'] = 'ATH'
            Dict['destination'] = j
            Dict['lastTicketingDate'] = res['lastTicketingDate']
            Dict['lastTicketingDateTime'] = res['lastTicketingDateTime']
